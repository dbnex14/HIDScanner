...
extern void *mono_aot_module_HIDScanner_iOS_info;
...
extern void *mono_aot_module_HIDScanner_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Xamarin_EnableKeyboardEffect_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_HIDScanner_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_HIDScanner_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Xamarin_EnableKeyboardEffect_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "HIDScanner.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
